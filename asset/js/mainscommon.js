...
function Diagnosis_Calc(resultValueKai, shindantire, shindantirekei) {
	...
	if (resultValueKai[27] != 0 && bodyOption1 == 10) taisuigripUp += 2600.0;
	if (resultValueKai[27] != 0 && bodyOption1 == 30) taisuigripUp += 5100.0;
	if (resultValueKai[27] != 0 && bodyOption2 == 10) taisuigripUp += 1300.0;
	if (resultValueKai[27] != 0 && bodyOption3 == 10) taisuigripUp += 1300.0;
