...
function View_Menus() {
	...
	menuValue[1] = new Array(34, 37, 3, 38);
	menuValue[2] = new Array(4, 6, 5, 7);
	menuValue[3] = new Array(-1, 8, 9, 10);
	menuValue[4] = new Array(-1, 35, -1, -1);
	menuValue[5] = new Array(-1, 14, 15, 16);
	menuValue[6] = new Array(-1, 11, 12, 13);
	menuValue[7] = new Array(-1, -1, -1, 17);
	menuValue[8] = new Array(-1, -1, 19, 18);
	menuValue[9] = new Array(-1, 20, 21, 22);
