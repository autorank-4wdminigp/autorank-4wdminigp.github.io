...
function View_Diagnosis() {
	...
	writeValue += "</tr></table>";
	writeValue += "<br><font color='#FFA500' size='2'>※3 参考値です(ブレーキは考慮せず、速いマシンの場合は表示より少し大きくなり、遅い場合は少し小さくなります)</font>";
	writeValue += "<br><font color='#FFA500' size='3'>※4 ほぼ解明(最適重心未実装)</font>";
